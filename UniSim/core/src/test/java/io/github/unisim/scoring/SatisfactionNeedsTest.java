...
public class SatisfactionNeedsTest {
    ...
    public void testGetSatisfactionWithMixedCapcities() {
        List<Building> buildings = new ArrayList<>();
        buildings.add(new Building(null, 0.0f, null, null, null, false, BuildingType.SLEEPING, "", 100, 0));
        buildings.add(new Building(null, 0.0f, null, null, null, false, BuildingType.LEARNING, "", 50, 0));
        buildings.add(new Building(null, 0.0f, null, null, null, false, BuildingType.EATING, "", 25, 0));
        float satisfaction = new SatisfactionNeeds().getSatisfaction(buildings, 100);
